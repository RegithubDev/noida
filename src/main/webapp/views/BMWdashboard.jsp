    ...
    <%--             <div class="row page-titles">
         		...
         		<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">BMW Cumulative Transactions Dashboard</h3>
                        ...
                        <div class="card" <c:if test="${obj.project_status ne 'Active' }">style="background-color: #808080;"</c:if>>
                            <div class="card-body">
                                <h4 class="card-title"> <%--  <i 
                                    ...
                                    ></i> --%> <i id="hide${index.count }"  <c:if test="${obj.company ne '' && obj.dailyCount == 0 && obj.dmNmae == 'bmw'}">
                                ...
                                <div class="text-right"><b>${obj.count }</b>  
                                    ...
                                    <span class="text-muted">Sync From&nbsp;:&nbsp; ${obj.min }<c:if test="${empty obj.min }"> Not Yet Started</c:if></span><br>
	  								<span class="text-muted">To&nbsp;:&nbsp; ${obj.DATEIN }<c:if test="${empty obj.DATEIN }"> - </c:if></span><br>
	  								<span class="text-muted">Last Sync Time &nbsp;:&nbsp; ${obj.visitDayTime }<c:if test="${empty obj.visitDayTime }"> - </c:if>
										</span>
	                                </div>
	                                  <hr>
                                    ${obj.project_name }<br>
