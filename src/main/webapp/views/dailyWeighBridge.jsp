    ...
    <%--             <div class="row page-titles">
         		...
         		<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">Daily Monitoring Dashboard &nbsp;</h3>
              ...
              <!--    
                ...
                <div class="row content" id="mainDashBoard">
                    <!-- Column -->
                    <c:forEach var="obj" items="${sitesList}" varStatus="index">
                  
                    <div class="col-lg-3 col-md-6" <c:if test="${obj.project_status ne 'Active' }">style="display: none;"</c:if>>
                      <div >
                        <div class="card" 
                        ...
                        >
                            ...
                            <div class="card-body">
                                <h4 class="card-title"> 
                                <i id="hide${index.count }"  <c:if test="${obj.company ne '' && obj.dailyCount == 0 && obj.dmNmae == 'bmw'}">
                                       class="mdi mdi-bullseye text-danger"
                                    </c:if>
                                    <c:if test="${obj.company ne '' && obj.dailyCount ne 0 && obj.dmNmae == 'bmw'}">
                                       class="mdi mdi-bullseye text-success"
                                    </c:if>
                                     <c:if test="${obj.dmNmae ne 'bmw' }">
                                    class="mdi mdi-bullseye text-success"
                                    </c:if>
                                ...
                                <div class="text-right"><b>
                                  ...
                                  <c:if test="${obj.company ne '' && obj.dailyCount == 0 && obj.dmNmae == 'bmw' }">
                                    ...
                                    <span class="text-muted">Today Date&nbsp;:&nbsp; ${obj.curDAte }</span><br>
                                    <hr>
                                    ${obj.project_name }<br>
                                    
                                    <c:if test="${obj.company ne '' }">
                                     ${obj.company }
                                    </c:if>
	                                </div>
	                            </div>
    	...
    	function changeRecordsOnSBU(){
    	 ...
    	 const stickyDiv = document.getElementById("stickyDiv");
    	    window.addEventListener("scroll", function () {
    	      ...
    	      const maxScroll = 500; // Adjust this value to control when transparency reaches 0
    	      const opacity = 1 - (scrollPosition / maxScroll);
    	      stickyDiv.style.opacity = opacity;
    	    });
    	    function updateOpacity() {
    	      ...
    	      stickyDiv.addEventListener("mouseenter", function () {
    	        // Reset opacity to 1 on mouse hover
    	        stickyDiv.style.opacity = 100;
    	      });

    	      stickyDiv.addEventListener("mouseleave", updateOpacity);
    	      
    	      var list = '${sitesList}'
    	    	  const objectList = JSON.parse(list);
    	      var len = jsonString.length;
    	      for (let i = 0; i < jsonString.length; i++) {
    	          $('#msw').append('ID: ' + jsonString[i].sbu );
    	        }
    </script>
</body>
